...
#include<stdlib.h>
%}
%token INT FLOAT CHAR DOUBLE VOID LONG CONST TYPEDEF STRUCT BOOL
...
forstmt : FOR '(' assignment ';' {fun1();} expr {fun2();} ';' assignment {fun3();} ')' block  {fun4();}
          ;
